...
axarr[0].plot([0,2], [10,10], color='k',linewidth=2.0)
axarr[0].plot([2,2], [9,10], color='k',linewidth=2.0)
axarr[0].plot([2,5], [9,9], color='k',linewidth=2.0)
axarr[0].plot([5,5], [9,7], color='k',linewidth=2.0)
axarr[0].plot([5,8], [7,7], color='k',linewidth=2.0)
axarr[0].plot([8,8], [7,3], color='k',linewidth=2.0)
axarr[0].plot([8,9.5], [3,3], color='k',linewidth=2.0)

axarr[0].arrow( 0, 9.5, 1.5, 0, width=0.01, head_width=0.2, head_length=0.2, fc='k', ec='k')
...
axarr[1].arrow( 0, 0, 2.8, 2.4, width=0.01, head_width=0.2, head_length=0.2, fc='k', ec='k')
...
axarr[1].text(4.0, 0.5, r'$W_{i-1/2}$', fontsize=20)
...
fname = 'problem_4_2_figure_a.png'
savefig(fname)
print 'Created ',fname
