...
#------------------------------
    ...
    probdata.add_param('a11',  -1.0,  'A[1,1]')
    probdata.add_param('a12',  1.0,  'A[1,2]')
    probdata.add_param('a21',  0.0,  'A[1,2]')
    probdata.add_param('a22',  2.0,  'A[2,2]')
    ...
    clawdata.upper[0] = 15.000000e+00          # xupper
    
    # Number of grid cells:
    clawdata.num_cells[0] = 1600      # mx
